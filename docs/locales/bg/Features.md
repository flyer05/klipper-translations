...
Klipper има няколко привлекателни функции:
...
* Klipper поддържа принтери с множество микроконтролери. Например един микроконтролер може да се използва за управление на екструдера, друг - за управление на нагревателите на принтера, а трети - за управление на останалата част от принтера. Софтуерът на Klipper хост изпълнява синхронизация на часовника, за да отчете отклонението на часовника между микроконтролерите. Не е необходим специален код, за да се активират няколко микроконтролера - необходими са само няколко допълнителни реда в конфигурационния файл.
