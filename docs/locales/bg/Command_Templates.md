...
Този документ предоставя информация за въвеждането на последователности от команди G-Code в секциите за конфигуриране gcode_macro (и други подобни).

## Именуване на макроси на G-Code
